...
class LibraryGenerator {
  ...
  Library generate() {
    ...
    final ignoreForFileComments = ['// ignore_for_file: unnecessary_lambdas', '// ignore_for_file: lines_longer_than_80_chars'];
    final getInstanceRefer = refer(_asExtension ? 'this' : 'get');
    final intiMethod = Method(
      (b) => b
        ..docs.addAll([if (!_asExtension) ...ignoreForFileComments, '/// initializes the registration of provided dependencies inside of [GetIt]'])
