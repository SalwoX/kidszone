...
class ThemeColors {
  //text colors //refactor hatası
/*
  static Color lightPink = HexColor("#EF9CC3");
  static Color text = HexColor("#000000");
  static Color textLight = HexColor("#6a6a77");
  static Color textBlack = HexColor("#6B6B6B");
*/
  static Color purpleColorCod = Color(0xff65539E);
}

const kPrimaryLightColor = Color(0xFFF1E6FF);

//const ThemeColors.beyaz = Color(0xFFffffff);
const Banking_TextLightGreenColor = Color(0xFF8ed16f);

const appBlackColor = Color(0xFF070706);
const appPalColor = Color(0xFF4a536b);

// Light Theme Colors
const appColorPrimary = Color(0xFF6F35A5);
const appColorPrimaryDark = Color(0xFF0A79DF);
const appColorAccent = Color(0xFF03DAC5);
const appTextColorPrimary = Color(0xff6551A0);
...
/// Kidszone Theme
/// start
const appborderColor = Color(0xFF212121);

const xtextColor = Color(0xFF5A5C5E);
const xborderColor = Color(0xFFDADADA);
const xview_color = Color(0xFFDADADA);
const xcolor_white = Color(0xFFffffff);
const xicon_color = Color(0xFF515BBE);

final colorpurple = Color.fromRGBO(101, 83, 158, 1);
final colorpink = Color.fromRGBO(239, 156, 195, 1);
final colorwhite = Color.fromRGBO(255, 255, 255, 1);
final lightPurple = Color(0XFFDAD5EC);
final lightBlue = Color(0xFF8BBEfC);
