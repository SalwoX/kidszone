...
class PageStudentAccountingDetail extends StatefulWidget {
  var vm = ViewModelAccounting();
  PageStudentAccountingDetail({Key? key}) : super(key: key);

  @override
  _PageStudentAccountingDetailState createState() => _PageStudentAccountingDetailState();
}

class _PageStudentAccountingDetailState extends State<PageStudentAccountingDetail> with LoggerMixin {
  ...
  void initState() async {
    ...
    for (var kid in widget.vm.studentListModel) {
      ...
      if (!kidsName.contains("\n")) {
        ...
        kid.nameSurname = kidsName.replaceFirst(kidsLastName, "\n" + kidsLastName);
      }
    }
    startSync();
  }
              ...
              child: Stack(
                children: [
                  AppBar(
                    ...
                    title: Text(LocaleKeys.schoolAccountingDetail_student_accounting.tr()),
                            ...
                            child: Column(
                              children: [
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            DropdownButton(
                                                ...
                                                onChanged: (value) {
                                                  setState(() {
                                                    educationPayment = value.toString();
                                                  });
                                                },
                                                value: educationPayment,
                                                items: paymentList.map((e) => DropdownMenuItem(value: e, child: Text(e.toString()))).toList()),
                                            Text(
                                              LocaleKeys.schoolAccountingDetail_education_payment.tr(),
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            boxShadow: [BoxShadow(color: Colors.black26, spreadRadius: 2, blurRadius: 5)],
                                            borderRadius:
                                                BorderRadius.horizontal(left: Radius.circular(MyBlock.horizontal(context, x: 10)), right: Radius.circular(MyBlock.horizontal(context, x: 5)))),
                                        child: Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              Container(
                                                  ...
                                                  decoration: BoxDecoration(shape: BoxShape.circle, color: Color(0xff6551A0)),
                                                  child: Icon(Icons.comment_outlined, color: Colors.white, size: MyBlock.horizontal(context, x: 9))),
                                              Expanded(
                                                  child: TextField(
                                                style: context.textTheme.bodyLarge,
                                                controller: noteEdit,
                                                decoration: InputDecoration(
                                                    ...
                                                    labelText: LocaleKeys.schoolAccountingDetail_comment.tr(),
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      LocaleKeys.schoolAccountingDetail_agreement_date.tr() +
                                          (widget.vm.studentAccountingRecord.agreementDate == null
                                              ? ''
                                              : DateFormat('dd.MM.yyyy').format(
                                                  widget.vm.studentAccountingRecord.agreementDate!,
                                                )),
                                      style: context.textTheme.bodyMedium,
                                    ),
                                    Text(
                                      LocaleKeys.condition_starting_price.tr() + widget.vm.studentAccountingRecord.startingPrice.toString(),
                                      style: context.textTheme.bodyMedium, //2.2
                                    ),
                                    Text(
                                      LocaleKeys.condition_contract_amount.tr() + widget.vm.studentAccountingRecord.agreementAmount.toString(),
                                      style: context.textTheme.bodyMedium,
                                    ),
                                  ],
                                ),
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          Expanded(
                                            ...
                                            child: Center(
                                              child: Text(
                                                ...
                                                style: context.textTheme.bodyLarge, //3.1
                                              ),
                                            ),
                                          ),
                                          Expanded(
                                          ...
                                          Expanded(
                                            ...
                                            child: Center(
                                              child: Text(
                                                LocaleKeys.condition_quantity.tr(),
                                                style: context.textTheme.bodyLarge,
                                              ),
                                            ),
                                          ),
                                          ...
                                          Expanded(
                                            ...
                                            child: Center(
                                              child: Text(
                                                LocaleKeys.accountingProcessPage_remainder.tr(),
                                                style: context.textTheme.bodyLarge,
                                              ),
                                            ),
                                          ),
                                      ...
                                      ListView(
                                        ...
                                        shrinkWrap: true,
                                        children: widget.vm.studentAccountingRecord.details!.map<Widget>((e) {
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            TextButton(
                                style: ButtonStyle(
                                    shape: MaterialStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(100))), backgroundColor: MaterialStateProperty.all(Color(0xff6551A0))),
                                onPressed: () => setState(() {}),
                                child: Text(
                            ...
                            TextButton(
                                ...
                                onPressed: () {},
                                child: Text(
                                  LocaleKeys.schoolAccountingDetail_payment_plan_delete.tr(),
                                  style: context.textTheme.bodyMedium,
                                )),
                          ],
                        ),
        ...
        Row(
          children: [
            Expanded(
              ...
              child: Center(
                child: Text(
                  (widget.vm.studentAccountingRecord.details!.indexWhere((element) => element == e) + 1).toString(),
                  style: context.textTheme.bodyLarge,
                ),
              ),
            ),
