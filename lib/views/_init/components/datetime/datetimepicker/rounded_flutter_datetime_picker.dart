  ...
  static Future<DateTime?> showTimePicker(
    ...
    return await Navigator.push(
      ...
      _DatePickerRoute(
        ...
        theme: theme,
        barrierLabel: MaterialLocalizations.of(context).modalBarrierDismissLabel,
        pickerModel: TimePickerModel(currentTime: currentTime, locale: locale, showSecondsColumn: showSecondsColumn),
      ),
    );
  }
  ...
  static Future<DateTime?> showDateTimePicker(
    ...
    return await Navigator.push(
        ...
        _DatePickerRoute(
            ...
            theme: theme,
            barrierLabel: MaterialLocalizations.of(context).modalBarrierDismissLabel,
            pickerModel: DateTimePickerModel(currentTime: currentTime, minTime: minTime, maxTime: maxTime, locale: locale)));
  }
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    pickerModel,
  })  : pickerModel = (pickerModel as BasePickerModel?) ?? DatePickerModel(),
...
class _DatePickerComponent extends StatefulWidget {
  ...
  const _DatePickerComponent({Key? key, required this.route, this.onChanged, this.locale, this.pickerModel});
        ...
        builder: (BuildContext context, Widget? child) {
          ...
          return ClipRect(
            child: CustomSingleChildLayout(
              delegate: _BottomPickerLayout(widget.route.animation!.value, theme, showTitleActions: widget.route.showTitleActions, bottomPadding: bottomPadding),
        ...
        children: <Widget>[
          Container(
            child: widget.pickerModel!.layoutProportions()[0] > 0
                ? _renderColumnView(ValueKey(widget.pickerModel!.currentMiddleIndex()! * 100 + widget.pickerModel!.currentLeftIndex()!), theme, widget.pickerModel!.leftStringAtIndex, leftScrollCtrl,
          ...
          Container(
            child: widget.pickerModel!.layoutProportions()[1] > 0
                ? _renderColumnView(ValueKey(widget.pickerModel!.currentRightIndex()), theme, widget.pickerModel!.middleStringAtIndex, middleScrollCtrl, widget.pickerModel!.layoutProportions()[1],
                    (index) {
          ...
          Container(
            child: widget.pickerModel!.layoutProportions()[2] > 0
                ? _renderColumnView(ValueKey(widget.pickerModel!.currentLeftIndex()), theme, widget.pickerModel!.rightStringAtIndex, rightScrollCtrl, widget.pickerModel!.layoutProportions()[2],
                    (index) {
...
class _BottomPickerLayout extends SingleChildLayoutDelegate {
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    double maxHeight = theme?.containerHeight ?? 0;
    if (showTitleActions!) {
      maxHeight += theme?.titleHeight ?? 0;
    }
    return BoxConstraints(minWidth: constraints.maxWidth, maxWidth: constraints.maxWidth, minHeight: 0.0, maxHeight: maxHeight + bottomPadding);
  }
  ...
  int? getItemCount() => this.itemCount;
}
