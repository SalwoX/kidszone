...
String? formatDate(DateTime? date, List<String> formats, LocaleType locale) {
  ...
  for (String format in formats) {
    if (format == yyyy) {
      ...
      String? monthLong = i18nObjInLocale(locale)!['monthLong'][date.month - 1].toString();
      sb.write(monthLong);
    } else if (format == M) {
      String? monthShort = i18nObjInLocale(locale)!['monthShort'][date.month - 1].toString();
      sb.write(monthShort);
    } else if (format == dd) {
      ...
      String? day = i18nObjInLocale(locale)!['day'][date.weekday - 1].toString();
