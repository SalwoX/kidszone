...
import 'package:kidszone_app/core/extension/convert_extension.dart';
...
import 'package:kidszone_app/views/_init/components/input/kz_edit_widgets.dart';
import 'package:kidszone_app/view/init/logger/logger_mixin.dart'; */
              ...
              Container(
                ...
                child: Center(
                  child: Container(
                    ...
                    child: Text("23 Eylül 2020", style: context.textTheme.bodySmall),
                  ),
                ),
              )
            ],
                      ...
                      ? Container(
                          child: Observer(builder: (_) {
                            return Column(
                              children: [
                                Text(
                                  LocaleKeys.pageHealthProcess_choose_student.tr(),
                              ...
                              return Column(
                                children: [
                                  ...
                                  KzTextEdit(
                                    ...
                                    labelText: LocaleKeys.pageHealthProcess_length.tr(),
                                  ...
                                  KzTextEdit(
                                    ...
                                    labelText: LocaleKeys.pageHealthProcess_kilo.tr(),
                                    inputType: TextInputType.number,
                                    isRequired: true,
                                    icon: Icons.height,
                                    onSaved: (value) {
                                  ...
                                  KzCheckBox(
                                    ...
                                    title: LocaleKeys.pageHealthProcess_chronic_disease.tr(),
          ...
          children: [
            ...
            Align(
              ...
              child: Container(
                ...
                height: MyBlock.vertical(context, x: 2),
                child: Center(child: FittedBox(fit: BoxFit.cover, child: Text((index + 1).toString(), style: context.textTheme.headlineLarge))),
              ),
            )
          ],
        ),
